    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppSpacing.gapV8,
          _buildEnvRow('AGORA_APP_ID', '5f80***1168'),
          _buildEnvRow('AGORA_APP_CERTIFICATE', '3f98***7b33'),
          _buildEnvRow('TOKEN_SERVER_URL', 'http://localhost:8080'),
          _buildEnvRow('AGORA_DEFAULT_CHANNEL', 'wtf_flutter_test'),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildEnvRow('RTC_PROVIDER', 'Agora RTC Engine SDK'),
